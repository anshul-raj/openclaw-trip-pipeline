...
- `/memory/multi-trip-link-logger/trips/<tripname>/details.md`
...
6. Write all creation outputs into `/memory/multi-trip-link-logger/trips/<tripname>/details.md`.
...
1. Create `/memory/multi-trip-link-logger/trips/<tripname>/details.md`.
...
## Trip Metadata Template (`/memory/multi-trip-link-logger/trips/<tripname>/details.md`)
...
- trip_name: trip1
- trip_path: /memory/multi-trip-link-logger/trips/trip1/details.md
- sheet_provider: gog
